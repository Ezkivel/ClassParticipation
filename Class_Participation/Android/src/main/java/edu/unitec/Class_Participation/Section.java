package edu.unitec.Class_Participation;
...
public class Section
{
    ...
    public Section(){}
    public Section(int _SectionId, int _CourseId, int _ProfessorId,
			int _SectionQuarter, int _SectionSemester, int _SectionYear)
    {
		super();
