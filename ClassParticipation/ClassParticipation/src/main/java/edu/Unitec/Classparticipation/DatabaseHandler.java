...
public class DatabaseHandler extends SQLiteOpenHelper
{
    ...
    // Table Professor Fields
    private static final String PROF_ID= "ProfessorId";
    private static final String PROF_NAME="ProfessorName";
    private static final String PROF_EMAIL = "ProfessorEmail";

    // Table Section
    private static final String TABLE_SECTION = "section";
    // Table Section Fields
    private static final String SECT_ID = "SectionId"; // N��mero de Secci��n
    private static final String SECT_COURSE = "CourseId";
    private static final String SECT_PROF = "ProfessorId";
    ...
    private static final String STU_ID = "StudentId";  //N��mero de Cuenta
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        String CREATE_SECTION_TABLE =
                "CREATE TABLE " + TABLE_SECTION + " (" +
                        ...
                        "FOREIGN KEY(" + SECT_PROF + ") REFERENCES " + TABLE_PROFESSOR + "(" + PROF_ID + ")" +
                        ")";
